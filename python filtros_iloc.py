...
print("\n--- 2. Fila en posición 24 ---")
print(df.iloc[24])

print("\n--- 3. Columnas 0,2,5 primeras 10 filas ---")
print(df.iloc[0:10, [0, 2, 5]])

print("\n--- 4. Celda (fila 10, columna 3) ---")
print(df.iloc[10, 3])

print("\n--- 5. Últimas 10 filas ---")
print(df.iloc[-10:])

print("\n--- 6. Filas 15 a 25, columnas 1 a 4 ---")
print(df.iloc[15:26, 1:5])

print("\n--- 7. Últimas 2 columnas ---")
print(df.iloc[:, -2:])

print("\n--- 8. Muestreo estratificado ---")
print(df.iloc[[0, 10, 20, 30, 40], [0, 5]])

print("\n--- 9. Primeras 3 columnas de últimas 10 filas ---")
print(df.iloc[-10:, 0:3])

print("\n--- 10. DataFrame invertido ---")
print(df.iloc[::-1])