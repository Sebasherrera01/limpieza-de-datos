...
print("\n--- 1. Nómina básica ---")
print(df.loc[:, ['Nombre', 'Salario_COP']])

print("\n--- 2. Filas 10 a 20 (Ciudad y Edad) ---")
print(df.loc[10:20, ['Ciudad', 'Edad']])

df2 = df.set_index('Nombre')
print("\n--- 3. Información de Elena Marín ---")
print(df2.loc['Elena Marín'])

print("\n--- 4. Experiencia de Maestría ---")
print(df.loc[df['Nivel_Estudio'] == 'Maestría', ['Experiencia_Años']])

print("\n--- 5. Barranquilla (Nivel a Remoto) ---")
print(df.loc[df['Ciudad'] == 'Barranquilla', 'Nivel_Estudio':'Remoto'])

print("\n--- 6. Salarios en Itagüí ---")
print(df.loc[df['Ciudad'] == 'Itagüí', ['Salario_COP']])

print("\n--- 7. Filas pares ---")
print(df.loc[df.index % 2 == 0, ['Nombre', 'Nivel_Estudio']])

print("\n--- 8. Mayores de 40 años ---")
print(df.loc[df['Edad'] > 40, ['Nombre', 'Remoto']])

print("\n--- 9. Últimos 5 registros ---")
print(df.loc[df.index[-5:]])

print("\n--- 10. Exactamente 10 años de experiencia ---")
print(df.loc[df['Experiencia_Años'] == 10, ['Ciudad']])
